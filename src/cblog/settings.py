...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.ck8obwia7nws.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesmelblog' # please enter your s3 bucket name
